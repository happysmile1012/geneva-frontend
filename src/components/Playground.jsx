...
function Playground({
  ...
  return loadingContent ? (
    ...
    <div className={`flex-1 flex flex-col overflow-y-auto`}>
      <div
        className={`overflow-y-auto scrollbar-neutral-800 ${
          filterList.length ? "flex-1" : ""
        }`}
      >
        {filterList.map((item, index) => {
          if (item.type == "question") {
            return (
              <div
                key={index}
                className="mx-auto flex flex-1 gap-4 md:max-w-3xl"
              >
                <div className="w-full px-4 py-4">
                  <div className="flex w-full flex-col gap-1 empty:hidden items-end rtl:items-start">
                    <div
                      className="relative max-w-[var(--user-chat-width,70%)] rounded-3xl py-2.5 text-2xl"
            ...
            return (
              <div
                key={index}
                className="mx-auto flex flex-col flex-1 md:max-w-3xl text-black my-4"
              >
                {
                  <div className="flex flex-col mx-4 dark:text-white text-xl my-6">
                    <div
                      className={`flex items-center gap-2 mt-6 verfied-top-modal-${index}`}
                    >
                      {item.mode !== "blaze" && (
                        <>
                          <img
                      ...
                      <img
                        src={`/image/${
                          item.verify_top_open ? "cancel_button" : "down"
                        }.png`}
                        alt="top"
                ...
                {!item.close && (
                  <div className="mx-4 px-4 py-4 shadow-[10px_-10px_black] bg-[#FEFBF0] rounded-[30px]">
                    <div>
                      <div align="center" className="text-[40px] font-bold">
                        Consensus
                      </div>
                      <MarkdownRenderer
                        content={item.text.replace("Consensus:", "")}
                        color={theme}
                        bg={true}
                      />
                    </div>
                ...
                {
                  <div
                    className={`flex flex-col mx-4 dark:text-white text-xl verfied-bottom-modal-${index}`}
                  >
                    <div className="flex items-center gap-2 mt-6">
                      ...
                      <img
                        src={`/image/${
                          item.verify_bottom_open ? "cancel_button" : "down"
                        }.png`}
                        alt="down"
                        className={`w-[30px] h-[30px] cursor-pointer`}
                  ...
                  <div className="flex flex-col mx-4 dark:text-white text-xl my-6">
                    <div className="flex items-center gap-2 mt-6">
                      ...
                      >
                        ...
                        out of {item.status_report.length} models
                      </span>
                      <img
                        src={`/image/${
                          item.verify_top_open ? "cancel_button" : "down"
            ...
            return (
              ...
              >
                <div
                  className="px-8 text-2xl mb-4 dark:text-white"
                  style={{ color: theme === "light" ? "dark" : "white" }}
                >
                  Certainly! Here are some options picked for you
                </div>
                <div className="w-full px-4 py-4 grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 justify-items-center">
                  {item.product.slice(0, 10).map((product, id) => {
                    return (
                      <div
                        key={id}
                      ...
                      >
                        ...
                        <div className="text-xl py-3 mb-0 mt-auto pl-3 w-full font-aptos">
                          {product.price}
                        </div>
                      </div>
                    );
                ...
                <div
                  className="px-8 text-2xl mt-4 dark:text-white"
                  style={{ color: theme === "light" ? "dark" : "white" }}
                >
                  You can also browse & shop from the Boom Marketplace{" "}
                  <a
                    link="#"
            ...
            return (
              ...
              >
                ...
                {item.product.length > 1 && (
                  <div className="w-full px-4 py-4 grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 justify-items-center">
      ...
      <div
        className={`flex mx-auto px-3 md:px-4 w-full pb-6 ${
          filterList.length ? "" : "flex-1"
        }`}
      >
        <div className="mx-auto flex flex-col flex-1 gap-4 md:gap-5 lg:gap-6 md:max-w-3xl xl:max-w-[48rem] justify-center items-center">
          {!filterList.length && (
            <div className="flex flex-col items-center">
              ...
              <span
                className="text-3xl my-15"
                style={{ color: theme === "light" ? "black" : "white" }}
              >
                We intelligently unify AIs to give you high-quality, trusted
                answers & smarter discovery
              </span>
            </div>
          )}
          <TextInput
...
function ProductSlider({ data, linkToProduct, id, product }) {
  ...
  return (
    <div className="flex align-center gap-[15] items-center">
      {data.thumbnails && data.thumbnails.length > 1 && (
        <div>
          <img
            src={`/image/dark-left.png`}
            width={20}
            height={20}
            onClick={() => {
